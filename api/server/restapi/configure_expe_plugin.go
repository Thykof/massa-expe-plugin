...
//go:generate swagger generate server --target ../../server --name ExpePlugin --spec ../../swagger.yml --principal interface{} --exclude-main

func configureFlags(api *operations.ExpePluginAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.ExpePluginAPI) http.Handler {
